...
<x-card class="bg-white p-4 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.prestazioni.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg shadow text-center inline-block w-fit ml-auto">Nuova Prestazione</a>
    </div>
            ...
            @foreach($prestazioni as $prestazione)
                <tr class="hover:bg-indigo-50 transition">
                    ...
                    <td class="px-6 py-3 flex gap-4 items-center">
                        <a href="{{ route('admin.prestazioni.edit', $prestazione->id) }}" class="text-indigo-600 hover:text-indigo-800" title="Modifica">
                        ...
                        <button type="button" class="delete-prestazione-btn text-red-600 hover:text-red-800" data-id="{{ $prestazione->id }}" title="Elimina">
