...
<div class="container mx-auto px-4 py-8 space-y-12">
    ...
    <header class="relative bg-indigo-700 rounded-xl overflow-hidden h-80">
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-start px-8">
            ...
            <a href="#prodotti" class="mt-4 inline-block bg-white text-indigo-700 font-semibold py-2 px-4 rounded-lg shadow hover:bg-indigo-100 transition">Scopri i prodotti</a>
        </div>
    </header>
    ...
    <section id="azienda" class="bg-white shadow-lg rounded-xl p-6 space-y-3">
        ...
        <p class="text-gray-700 text-sm">📞 Telefono: <a href="tel:+390712345678" class="text-blue-600 underline">071 2345678</a></p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @foreach($centri_assistenza as $centro)
                <div class="bg-white rounded-xl shadow p-4 hover:shadow-md transition">
                    <h3 class="text-lg font-semibold text-indigo-700">{{ $centro->nome }}</h3>
