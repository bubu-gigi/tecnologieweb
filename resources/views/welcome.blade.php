...
<div class="welcome-container">
    <header class="relative">
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-start px-12">
            ...
            <a href="{{ asset('Documentazione_Progetto.pdf') }}" target="_blank" class="mt-2 text-white px-4 py-2 rounded-lg cursor-pointer bg-indigo-600 hover:bg-indigo-700 font-semibold">Documentazione</a>
        </div>
    </header>
